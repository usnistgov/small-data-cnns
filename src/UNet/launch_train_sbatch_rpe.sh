...
#SBATCH --gres=gpu:1
#SBATCH --job-name=unet-m
#SBATCH -o unet-m_%N.%j.out
#SBATCH --time=48:0:0


dataset="rpe"
experiment_name="unet-$dataset"
...
do
    ...
    do
        ...
        if [ ! -d "$results_dir" ]; then
            ...
            # launch training script with required options
            checkpoint_fp="/wrk/mmajursk/small-data-cnns/UNet-Gan/ugan-rpe-20190315T143812/checkpoint/model.ckpt"
            echo "Launching Training Script"
