...
if __name__ == "__main__":
    ...
    img_files_mini = img_files[0:100]
    print('building train database')
    database_name = 'gan-{}-mini.lmdb'.format(dataset_name)
    generate_database(img_files_mini, database_name, image_folder)
    ...
    print('building train database')
    database_name = 'gan-{}.lmdb'.format(dataset_name)
    generate_database(img_files, database_name, image_folder)
